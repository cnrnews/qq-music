<template>
  <div class="player" v-show="playlist.length>0">
    ...
    >
      <div ref="cdContainer" class="normal-player" v-show="fullScreen">
...
export default {
  ...
  methods: {
    back() {
      ...
      this.$refs.cdContainer.style.display = "none";
    },
    open() {
    ...
    leave(el, done) {
      ...
      this.$refs.cdWrapper.style[
        transform
      ] = `transform3d(${x}px,${y}px,0) scale(${scale})`;
